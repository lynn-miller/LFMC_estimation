...
if __name__ == '__main__':
    ...
    experiment = ExperimentParams({
        'name': 'europe_1000_freeze-conv',
        'description': 'Europe: Pretrained on CONUS; Freeze 1st convolutional layer; 1000 training samples',
        'tests': [
    ...
    model_params['transferModel'] = {'method': 'freeze_layers', 'layers': ['optical0', 'weather0']}
