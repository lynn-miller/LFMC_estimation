...
if __name__ == '__main__':
    ...
    experiment = ExperimentParams({
        'name': 'europe_200_no-transfer',
        'description': 'Europe: no pretraining; 200 training samples',
        'tests': [
    ...
    model_params['samplesFilter'] = {'apply': 'train', 'method': 'random', 'params': [200]}
    ...
    model_params['gpuMemory'] = 512    # GPU memory for each worker
