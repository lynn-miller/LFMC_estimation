...
if __name__ == '__main__':
    ...
    # np.random.seed(1234)
    # model_seeds = list(np.random.randint(1000, 9999, (20,20), dtype='int32'))
    # for ms in range(20):
        # model_seeds[ms] = [int(s) for s in model_seeds[ms]]
    random.seed(2023)
    ...
    experiment = ExperimentParams({
        'name': 'australia_no-transfer',
        'description': 'Australia: no pretraining; all training data',
        'tests': [
