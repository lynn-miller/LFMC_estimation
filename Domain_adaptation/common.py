...
MODELS_DIR = os.path.join(DATA_DIR, 'LFMC_models')       # Model output and results
CZONE_MODELS_DIR = os.path.join(DATA_DIR, 'Climate-Zone')       # Model output and results
...
GDAL_DATA = os.path.join(os.environ['CONDA_PREFIX'], 'share' 'gdal')
