""" LFMC Within-site omit one input
Runs input ablation tests for the within-site models - each test omits a new
input or a group of auxiliary inputs.
""" 
...
if __name__ == '__main__':
    ...
    # =============================================================================
    experiment = {
        'name': 'within_site_omit_one',
        'description': 'Input abalation tests',
        'layerTypes': ['modisConv', 'prismConv', 'fc'],
        'tests': [
            {'dataSources': ['modis', 'aux'], 'prismConv': {'numLayers': 0} },
            {'auxOneHotCols': []},
