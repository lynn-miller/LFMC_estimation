    ...
    experiment = ExperimentParams({
        ...
        'tests': [
            ...
            {'testName': '1-month lead time',
             'inputs': {'modis': {'start': -336, 'end': 29},
                        'prism': {'start': -336, 'end': 29}}},
            {'testName': '2-months lead time',
             'inputs': {'modis': {'start': -305, 'end': 60},
                        'prism': {'start': -305, 'end': 60}}},
            {'testName': '3-months lead time',
             'inputs': {'modis': {'start': -275, 'end': 90},
                        'prism': {'start': -275, 'end': 90}}},
            {'testName': '4-months lead time',
             'inputs': {'modis': {'start': -244, 'end': 121},
                        'prism': {'start': -244, 'end': 121}}},
            {'testName': '5-months lead time',
             'inputs': {'modis': {'start': -214, 'end': 151},
                        'prism': {'start': -214, 'end': 151}}},
            {'testName': '6-months lead time',
             'inputs': {'modis': {'start': -183, 'end': 182},
                        'prism': {'start': -183, 'end': 182}}},
            {'testName': '7-months lead time',
             'inputs': {'modis': {'start': -153, 'end': 212},
                        'prism': {'start': -153, 'end': 212}}},
            {'testName': '8-months lead time',
             'inputs': {'modis': {'start': -123, 'end': 242},
                        'prism': {'start': -123, 'end': 242}}},
            {'testName': '9-months lead time',
             'inputs': {'modis': {'start': -92, 'end': 273},
                        'prism': {'start': -92, 'end': 273}}},
            {'testName': '10-months lead time',
             'inputs': {'modis': {'start': -62, 'end': 303},
                        'prism': {'start': -62, 'end': 303}}},
            {'testName': '11-months lead time',
             'inputs': {'modis': {'start': -31, 'end': 334},
                        'prism': {'start': -31, 'end': 334}}},
            {'testName': '1-year lead time',
             'inputs': {'modis': {'start': -1, 'end': 364},
                        'prism': {'start': -1, 'end': 364}}},
        ],
        'restart': 0, 
        'rerun': None,
